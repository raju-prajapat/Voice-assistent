 ...
 */
export const getAnalyzeOpenaiImageUrl = () => {
  return `/api/openai/analyze-image`;
};

export const analyzeOpenaiImage = async (
  analyzeImageBody: AnalyzeImageBody,
  options?: RequestInit,
): Promise<AnalyzeImageResponse> => {
  return customFetch<AnalyzeImageResponse>(getAnalyzeOpenaiImageUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
export const getAnalyzeOpenaiImageMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof analyzeOpenaiImage>>,
    TError,
  ...
  TContext
> => {
  const mutationKey = ["analyzeOpenaiImage"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return analyzeOpenaiImage(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type AnalyzeOpenaiImageMutationResult = NonNullable<
  Awaited<ReturnType<typeof analyzeOpenaiImage>>
>;
export type AnalyzeOpenaiImageMutationBody = BodyType<AnalyzeImageBody>;
export type AnalyzeOpenaiImageMutationError = ErrorType<unknown>;

/**
 * @summary Analyze an uploaded image with AI
 */
export const useAnalyzeOpenaiImage = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getAnalyzeOpenaiImageMutationOptions(options));
};
